...
### Initial solution
Initial proposal and source code along with optimizations have been made as per the reasoning given in the "Wireless Report - README.pdf". Some of the visual effects of using linear scan antenna array can be found below: 
